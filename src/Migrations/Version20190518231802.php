 ...
 */
final class Version20190518231802 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO credit_log_actions (cla_name) VALUES
                            (\'Scrybe_file\'),
                            (\'Top_up_credits\')');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_credit_log CHANGE ucl_userfile_id_id ucl_userfile_id_id INT DEFAULT NULL');
        $this->addSql('DELETE FROM credit_log_actions WHERE cla_name IN (\'Scrybe_file\', \'Top_up_credits\')');
    }
}
